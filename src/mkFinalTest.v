...
//
// On Thu Nov  7 14:58:57 IST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkFinalTest(CLK,
  ...
  wire WILL_FIRE_RL_initial_push, WILL_FIRE_RL_push_till_last_address;

  // inputs to muxes for submodule ports
  wire [15 : 0] MUX_address$write_1__VAL_2, MUX_read_count$write_1__VAL_2;

  // remaining internal signals
  wire [15 : 0] x__h1555, x__h1575, x__h1598;
  wire [7 : 0] x__h1989,
	       x__h2079,
	       x__h2261,
	       x__h2441,
  ...
  assign MUX_address$write_1__VAL_2 =
	     (read_count == 16'd254) ? x__h1555 : x__h1598 ;
  assign MUX_read_count$write_1__VAL_2 =
	     (read_count == 16'd254) ? 16'd2 : x__h1575 ;
  ...
  // register h_01
  assign h_01$D_IN =
	     (c_fifo_1$D_OUT < c_fifo_0$D_OUT) ? 8'd0 : x__h2079 - y__h2080 ;
  assign h_01$EN =
	     c_fifo_0_i_notEmpty__2_AND_c_fifo_1_i_notEmpty_ETC___d38 &&
	     address > 16'd3 ;

  // register hh
  assign hh$D_IN = (h_01 < h_00) ? 8'd0 : x__h2441 - y__h2442 ;
  assign hh$EN =
	     c_fifo_0_i_notEmpty__2_AND_c_fifo_1_i_notEmpty_ETC___d38 &&
	     address > 16'd3 ;

  // register hl
  assign hl$D_IN = x__h2441 + y__h2442 ;
  assign hl$EN =
	     c_fifo_0_i_notEmpty__2_AND_c_fifo_1_i_notEmpty_ETC___d38 &&
	     address > 16'd3 ;

  // register l_00
  assign l_00$D_IN = x__h1989 + y__h1990 ;
  assign l_00$EN =
	     c_fifo_0_i_notEmpty__2_AND_c_fifo_1_i_notEmpty_ETC___d38 &&
	     address > 16'd3 ;

  // register l_01
  assign l_01$D_IN = x__h2079 + y__h2080 ;
  assign l_01$EN =
	     c_fifo_0_i_notEmpty__2_AND_c_fifo_1_i_notEmpty_ETC___d38 &&
	     address > 16'd3 ;

  // register lh
  assign lh$D_IN = (l_01 < l_00) ? 8'd0 : x__h2261 - y__h2262 ;
  assign lh$EN =
	     c_fifo_0_i_notEmpty__2_AND_c_fifo_1_i_notEmpty_ETC___d38 &&
	     address > 16'd3 ;

  // register ll
  assign ll$D_IN = x__h2261 + y__h2262 ;
  assign ll$EN =
	     c_fifo_0_i_notEmpty__2_AND_c_fifo_1_i_notEmpty_ETC___d38 &&
	     address > 16'd3 ;
  ...
  assign row_fifo_0_i_notFull_AND_row_fifo_1_i_notFull__ETC___d7 =
	     ...
	     c_fifo_1$FULL_N ;
  assign x__h1555 = address + 16'd258 ;
  assign x__h1575 = read_count + 16'd2 ;
  assign x__h1598 = address + 16'd2 ;
  assign x__h1989 = row_fifo_1$D_OUT >> 1 ;
  assign x__h2079 = c_fifo_1$D_OUT >> 1 ;
  assign x__h2261 = l_01 >> 1 ;
  assign x__h2441 = h_01 >> 1 ;
  assign y__h1990 = row_fifo_0$D_OUT >> 1 ;
  assign y__h2080 = c_fifo_0$D_OUT >> 1 ;
  assign y__h2262 = l_00 >> 1 ;
  assign y__h2442 = h_00 >> 1 ;
  ...
  begin
    #0;
    if (RST_N != `BSV_RESET_VALUE) $display(ll);
    if (RST_N != `BSV_RESET_VALUE) $display(ll);
    if (RST_N != `BSV_RESET_VALUE) $display(ll);
