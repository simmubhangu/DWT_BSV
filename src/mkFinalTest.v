...
//
// On Thu Oct 31 15:38:34 IST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkFinalTest(CLK,
  ...
  // remaining internal signals
  assign hh__h1971 = (h_01 < h_00) ? 8'd0 : x__h2251 - y__h2252 ;
  assign hl__h1970 = x__h2251 + y__h2252 ;
  assign lh__h1969 = (l_01 < l_00) ? 8'd0 : x__h2117 - y__h2118 ;
  assign ll__h1968 = x__h2117 + y__h2118 ;
  ...
  assign x__h2117 = l_01 >> 1 ;
  assign x__h2251 = h_01 >> 1 ;
  assign y__h1866 = row_fifo_0$D_OUT >> 1 ;
  assign y__h1956 = c_fifo_0$D_OUT >> 1 ;
  assign y__h2118 = l_00 >> 1 ;
  assign y__h2252 = h_00 >> 1 ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_first_coefficient)
	$display(ll__h1968, lh__h1969, hl__h1970, hh__h1971);
  end
  // synopsys translate_on
